...
export default function ResetPage() {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4">
      ...
      >
        <h1 className="text-2xl font-black text-ink">Resetar senha</h1>
        <div className="mt-4 space-y-3">
          <input name="token" placeholder="Token" required className="w-full rounded-lg border border-slate-300 px-3 py-2" />
          <input
            name="password"
            type="password"
