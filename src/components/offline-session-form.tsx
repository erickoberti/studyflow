...
export function OfflineSessionForm() {
  ...
  async function submit() {
    ...
    try {
      ...
      const now = new Date(); setCorrect(0); setWrong(0); setNotes(""); setDifficulty("Média"); setMinutes(60); setDate(dayKey(now)); setTime(timeKey(now)); setDisciplineId(""); setSubjectId("");
